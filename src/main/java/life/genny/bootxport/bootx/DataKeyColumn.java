...
public class DataKeyColumn {
    public final static Set<String> CODE = new HashSet<>();
    public static Set<String> CODE_BA = new HashSet<>();
    public static Set<String> CODE_TARGET_PARENT_LINK = new HashSet<>();
    public static Set<String> CODE_TARGET_PARENT = new HashSet<>();
    public static Set<String> CODE_QUESTION_SOURCE_TARGET = new HashSet<>();
