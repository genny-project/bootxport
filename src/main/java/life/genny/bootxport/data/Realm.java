...
//
//
//  private Map<String, String> modulePath = new HashMap<>();
//
//  private String name;
...
//  }
//
//  public Map<String, String> getModulePath() {
//    return modulePath;
//  }
//
...
//    this.name = name;
//    modulePath.put("sheetID", System.getProperty("user.home").concat(
//        "/.genny/multitenancy/" + name + "/" + "modules.xlsx"));
//    modulePath.put("code", name);
//  }
//
